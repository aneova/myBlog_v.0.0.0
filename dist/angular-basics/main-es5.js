      ...
      function ListMusicService() {
        ...
        this.myDate = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (obs) {
          setInterval(function () {
            obs.next(100 - 100 * (_this2.audioObj.duration - _this2.audioObj.currentTime) / _this2.audioObj.duration);
            _this2.strTime = _this2.getformatedTime(_this2.audioObj.currentTime);
          }, 500);
        });
      }
